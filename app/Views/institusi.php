        ...
        <div class="flex flex-col md:flex-row md:items-center justify-between mb-8 gap-4">
            <div>
                <h1 class="text-3xl font-bold text-primary">
                    Direktori Anggota Institusi
                </h1>
                <p class="text-gray-600">
                    Daftar institusi pendidikan tinggi anggota APTIKOM Jatim.
                </p>
            </div>
            <div class="relative">
                <input
    ...
    <div class="flex min-h-full items-center justify-center p-4">
        ...
        <div class="relative bg-white rounded-lg shadow-xl max-w-2xl w-full mx-auto">
            ...
            <div class="bg-primary px-6 py-4 flex items-center justify-between rounded-t-lg">
                <h3 class="text-lg font-bold text-white">Detail Anggota Institusi</h3>
                ...
                tr.innerHTML = `
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="flex items-center">
                            <div class="flex-shrink-0 h-10 w-10 bg-primary/10 rounded-full flex items-center justify-center text-primary font-bold text-xs">
                                ${member.logo}
                            </div>
                            <div class="ml-4">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-600">${member.type}</div>
                    </td>
                    <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-600">${member.province}</div>
                    </td>
        ...
        modalContent.innerHTML = `
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div class="md:col-span-2">
                    <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">Nama Institusi</label>
                    <p class="text-sm font-bold text-gray-900">${member.name}</p>
                </div>
                <div>
                    <label class="block text-xs font-semibold text-gray-500 uppercase mb-1">Bentuk</label>
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-sm text-gray-700">${member.address || '-'}</p>
                </div>
                <div>
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-700">
                        ${member.website ? `<a href="${member.website}" target="_blank" rel="noopener noreferrer" class="text-primary hover:underline">${member.website}</a>` : '-'}
                    </p>
                </div>
                <div>
